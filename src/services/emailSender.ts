...
export default class EmailSender {
  ...
  static get TEMPLATES() {
    ...
    return {
      ...
      EMAIL_TO_SUPPORT:
        getConfig().SENDGRID_TEMPLATE_EMAIL_TO_SUPPORT,
      EMAIL_ON_COMINGSOON:
        getConfig().SENDGRID_TEMPLATE_EMAIL_ON_COMINGSOON,
      KYC_REQUEST_ACCEPTED:
        getConfig().SENDGRID_TEMPLATE_KYC_REQUEST_ACCEPTED,
      KYC_REQUEST_REJECTED:
        getConfig().SENDGRID_TEMPLATE_KYC_REQUEST_REJECTED,
    };
  }
  ...
  static get SUPPORT_EMAIL() {
    return getConfig().SENDGRID_EMAIL_TO;
  }
}
