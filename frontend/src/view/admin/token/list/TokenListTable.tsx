...
import TokenListItem from 'src/view/admin/token/list/TokenListItem';
import tokenSelectors from 'src/modules/token/tokenSelectors';
import moment from 'moment';

function TokenListTable(props) {
        ...
        <Table>
          <MDBox component="thead">
            <TableRow>
              ...
              <DataTableHeadCell
                onClick={() => doChangeSort('tokenNumber')}
                sorted={
                  sorter.field === 'tokenNumber'
                    ? sorter.order
                    : 'none'
                }
              >
