...
const schema = yup.object().shape({
  ...
  coordinateX: yupFormSchemas.decimal(
    i18n('property.fields.coordinateX'),
    {
      required: true,
    },
  ),
  coordinateY: yupFormSchemas.decimal(
    i18n('property.fields.coordinateY'),
    {
      required: true,
    },
  ),
  ...
  description: yupFormSchemas.string(
    i18n('property.fields.description'),
    {},
  ),
  ...
  durationProjectInMonth: yupFormSchemas.integer(
    i18n('property.fields.durationProjectInMonth'),
    {
      min: 0,
      max: 200,
    },
  ...
  status: yupFormSchemas.enumerator(
    ...
    {
      required: true,
      options: propertyEnumerators.status,
    },
  ),
  ...
  initialDateSTO: yupFormSchemas.date(
    i18n('property.fields.initialDateSTO'),
    {},
  ),
  endDateSTO: yupFormSchemas.date(
    i18n('property.fields.endDateSTO'),
    {},
  ),
  suppliedTokensNumber: yupFormSchemas.decimal(
    i18n('property.fields.suppliedTokensNumber'),
    {},
  ),
  investorsNumber: yupFormSchemas.integer(
    i18n('property.fields.investorsNumber'),
    {},
  ),
  tokenPrice: yupFormSchemas.decimal(
    i18n('property.fields.tokenPrice'),
    {},
  ),
  tokenizedCostAmount: yupFormSchemas.decimal(
    i18n('property.fields.tokenizedCostAmount'),
    {},
  ),
  softcap: yupFormSchemas.decimal(
    i18n('property.fields.softcap'),
    {},
  ),
  hardcap: yupFormSchemas.decimal(
    i18n('property.fields.hardcap'),
    {},
  ),
  photographs: yupFormSchemas.images(
    i18n('property.fields.photographs'),
    {
      min: 1,
      max: 10,
    },
  ),
  TIR: yupFormSchemas.decimal(
    i18n('property.fields.TIR'),
    {},
  ),
  ...
  APY: yupFormSchemas.decimal(i18n('property.fields.APY'), {
    required: true,
  }),
  minAmountOnSelling: yupFormSchemas.decimal(
    i18n('property.fields.minAmountOnSelling'),
    {},
  ),
});
          ...
          <Grid spacing={1.6} container sx={{ mb: 3 }}>
            ...
            <Grid item md={6} xs={12}>
              <ImagesFormItem
                ...
                storage={Storage.values.propertyPhotographs}
                max={10}
              />
            </Grid>
          </Grid>
