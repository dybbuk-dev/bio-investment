...
import CustomerStatusView from 'src/view/admin/customer/list/CustomerStatusView';
                    ...
                    >
                      ...
                      {hasPermissionToEdit &&
                        row.status === 'requested' && (
                          <Tooltip
                            disableInteractive
                            title={i18n('common.verify')}
                          >
                            <IconButton
                              size="small"
                              component={Link}
                              to={`/admin/customer/${row.id}/verify`}
                              color={sidenavColor}
                            >
                              <SecurityIcon />
                            </IconButton>
